...
[_QWERTY] = LAYOUT_preonic_grid( \
  ...
  NAVIGAT, KC_LCTL, KC_LALT, KC_LGUI, LOWER,   KC_SPC,  KC_RSFT, RAISE,   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT  \
),
...
[_COLEMAK] = LAYOUT_preonic_grid( \
  ...
  KC_APP , KC_LCTL, KC_LALT, KC_LGUI, LOWER,   KC_SPC,  KC_RSFT, RAISE,   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT  \
),
...
/* Navigate, or mouse controls (FN Button, Lower Left)
 * ,-----------------------------------------------------------------------------------.
 * |      |      |      |      |      |      |      |      |      |      |      |      |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |      |  LMB |MouseU|  RMB |      |      |      |      |      |      |      |      |
 ...
 * |      |      |      |      |      |      |      |      |      |      |      |      |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |      |      |MACL 2|MACL 1|      |  MMB |MACL 0|      |ScrllL|ScrllD|ScrllU|ScrllR|
 * `-----------------------------------------------------------------------------------'
 */
[_NAVIGATE] = LAYOUT_preonic_grid( \
  ...
  _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, \
  _______, _______, KC_ACL2, KC_ACL1, _______, KC_BTN3, KC_ACL0, _______, KC_WH_L, KC_WH_D, KC_WH_U, KC_WH_R  \
)
